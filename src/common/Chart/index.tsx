...
>(({ id, className, children, config, ...props }, ref) => {
	...
	return (
		<ChartContext.Provider value={{ config, ref }}>
			<div
				data-chart={chartId}
				ref={ref}
								...
								{formatter && item?.value !== undefined && item.name ? (
									...
									<>
										...
										<div
											...
											data-nested={nestLabel ? "true" : undefined}
										>
											<div className={styles.tooltipContentInner}>
												{nestLabel ? tooltipLabel : null}
												<span className={styles.tooltipContentInner}>
...
>(
	(
		...
		return (
			<div ref={ref} className={cn(styles.legend, className)}>
				{payload.map((item) => {
